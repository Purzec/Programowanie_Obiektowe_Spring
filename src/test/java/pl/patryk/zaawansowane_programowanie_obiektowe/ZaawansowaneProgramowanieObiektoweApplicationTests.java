package pl.patryk.zaawansowane_programowanie_obiektowe;
...
import pl.patryk.zaawansowane_programowanie_obiektowe.service.ProjektService;
import pl.patryk.zaawansowane_programowanie_obiektowe.model.Projekt;

@SpringBootTest
@AutoConfigureMockMvc
@WithMockUser(username = "admin", password = "admin")
class ProjektRestControllerTest {
